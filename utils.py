"""
Utility functions for the artform upload system
"""
...
def setup_logging(config: LoggingConfig) -> logging.Logger:
    ...
    logger = logging.getLogger('artform_uploader')
    ...
    if config.file_output:
        log_filename = f"artform_upload_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
